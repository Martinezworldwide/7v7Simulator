...
export var PLAYER_SEPARATION_DISTANCE = 3.5; // Min distance between teammates
export var PLAYER_SEPARATION_FORCE = 8.0; // How strongly they push apart
...
export var TACTICAL_ATTACK_PUSH = 8.0; // How far the attacking shape sits ahead of the ball
export var TACTICAL_DEFENSIVE_LINE = 18.0; // Depth of the defensive line from own goal
export var TACTICAL_COMPACTNESS = 0.45; // How tightly the team compresses when defending
export var TACTICAL_VERTICAL_FOLLOW = 0.35; // How much the formation follows ball movement on Z
export var TACTICAL_MAX_LOOSE_BALL_CHASERS = 2; // Max players per team that swarm a loose ball
export var TACTICAL_STATIONARY_BALL_SPEED_SQ = 0.8; // Ball speed squared treated as "stopped"
export var TACTICAL_HOLD_DISTANCE = 2.5; // Distance at which a player holds their tactical position
export var TACTICAL_PRESS_DISTANCE = 16.0; // How close forwards must be before they trigger a press
...
export var PASS_PROBABILITY = 0.08; // Base chance to pass per update frame when a target is open
